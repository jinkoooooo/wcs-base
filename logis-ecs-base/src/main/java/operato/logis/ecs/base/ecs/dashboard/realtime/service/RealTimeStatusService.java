...
public class RealTimeStatusService extends AbstractQueryService {
    ...
    public List<TbEqCraneMst> getAllCarStatus() {
        ...
        return this.queryManager.selectList(TbEqCraneMst.class, condition);
    }
     ...
     */
    @Transactional(readOnly = true)
    public List<TbEqCraneMst> getCarStatusByGroup(String eqGroupId) {
        String sql = """
            SELECT car.*
        ...
        return this.queryManager.selectListBySql(sql, params, TbEqCraneMst.class, 0, 0);
    }
     ...
     */
    @Transactional(readOnly = true)
    public TbEqCraneMst getCarStatus(String eqId) {
        Query condition = new Query();
        condition.addFilter("eqId", eqId);
        condition.setMaxResultSize(1);
        return this.queryManager.selectByCondition(TbEqCraneMst.class, condition);
    }
     ...
     */
    @Transactional(readOnly = true)
    public List<TbWcsCraneOrder> getActiveOrders() {
        // TODO: 실제 코드값으로 바꿔
        ...
        return this.queryManager.selectListBySql(sql, params, TbWcsCraneOrder.class, 0, 0);
    }

    /** 상태별 WCS 작업 목록 조회 */
    @Transactional(readOnly = true)
    public List<TbWcsCraneOrder> getOrdersByStatus(Integer orderStatus) {
        Query condition = new Query();
     ...
     */
    @Transactional(readOnly = true)
    public List<TbWcsCraneOrder> getOrdersByShuttle(String shuttleId) {
        Query condition = new Query();
    ...
    @Transactional(readOnly = true)
    public TbWcsCraneOrder getOrder(String orderKey) {
        Query condition = new Query();
    ...
    /** 에러 상태 작업 목록 조회 */
    @Transactional(readOnly = true)
    public List<TbWcsCraneOrder> getErrorOrders() {
    ...
    /** 최근 완료된 작업 목록 조회 */
    @Transactional(readOnly = true)
    public List<TbWcsCraneOrder> getRecentCompletedOrders(int limit) {
        ...
        return this.queryManager.selectListBySql(sql, params, TbWcsCraneOrder.class, 0, limit);
    }
    ...
    public Map<String, Object> getDashboardInitialData(String lcId, String pageId) {
        ...
        List<TbWcsCraneOrder> orders = getActiveOrders();
    ...
    public Map<String, Object> requestCancelOrder(String orderKey, String reason) {
        ...
        TbWcsCraneOrder order = this.getOrder(orderKey);
        if (order == null) {
