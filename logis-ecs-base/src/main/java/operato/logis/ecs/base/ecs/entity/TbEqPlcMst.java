...
public class TbEqPlcMst extends ElidomStampHook {
    ...
    public static List<TbEqPlcMst> testDataList() {
        ...
        testDatalist.add(testData("TEST_EQ_CRANE_1", "192.168.0.1", 5000, MelsecConsts.InterfaceType.BINARY, EcsDBConsts.PlcEqType.SHUTTLE_CAR));
        testDatalist.add(testData("TEST_EQ_CRANE_2", "192.168.0.2", 5000, MelsecConsts.InterfaceType.BINARY, EcsDBConsts.PlcEqType.SHUTTLE_CAR));
