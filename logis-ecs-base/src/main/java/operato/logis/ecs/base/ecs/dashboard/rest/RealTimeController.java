...
import operato.logis.ecs.base.ecs.dashboard.service.impl.RealTimeDataService;
...
public class RealTimeController {
    ...
    @ResponseStatus(HttpStatus.OK)
    public List<TbEqCraneMst> getShuttlesByGroup(@PathVariable String eqGroupId) {
        return realTimeDataService.getShuttlesByGroup(eqGroupId);
    }

    @GetMapping("/shuttles/group/{eqGroupId}/floor/{floor}")
    @ResponseStatus(HttpStatus.OK)
    public List<TbEqCraneMst> getShuttlesByGroupAndFloor(
            @PathVariable String eqGroupId,
            @PathVariable int floor) {
