...
import operato.logis.ecs.base.ecs.dashboard.realtime.dto.CranePositionDto;
...
@Service
public class CraneDataProvider extends AbstractQueryService implements RealTimeDataProvider<CranePositionDto> {

    private static final Logger logger = LoggerFactory.getLogger(CraneDataProvider.class);
    ...
    @Override
    public List<CranePositionDto> fetchData(RealTimeFetchContext ctx) {
...
//            logger.info("rackCellMap : ${}", rackCellMap);
            ...
            List<CranePositionDto> result = new ArrayList<>();
            ...
            for (Map row : rows) {
                ...
                String statusDesc = EcsDBConsts.EqCraneStatus.find(status).getDescription();
                ...
                CranePositionDto dto = CranePositionDto.builder()
