 ...
 *
 * [작업 계층 구조]
 * 1. WCS Level: tb_wcs_crane_order (상위 오더)
 * 2. ECS_RACK Level: tb_ecs_rack_order (스태커크레인 PICK/DROP 단위)
...
public class JobStatusDto {
    ...
    /** 할당된 설비 ID (스태커크레인/리프터/CV) */
    private String assignedEquipmentId;

    /** 할당된 설비 타입 (CRANE/LIFTER/CONVEYOR/RACK/UNKNOWN) */
    private String assignedEquipmentType;

    /** 할당된 스태커크레인 ID (deprecated, use assignedEquipmentId) */
    @Deprecated
    private String assignedCraneId;
