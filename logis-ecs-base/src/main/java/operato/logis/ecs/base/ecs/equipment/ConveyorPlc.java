...
import operato.logis.ecs.base.ecs.plc.conveyor.ConveyorWriteMap;

import java.util.List;

@Getter
public class ConveyorPlc extends BaseMelsecTypeEquipemnt {
    ...
    public ConveyorPlc(String id, String ip, int readPort, int sendPort, MelsecConsts.InterfaceType plcType,
