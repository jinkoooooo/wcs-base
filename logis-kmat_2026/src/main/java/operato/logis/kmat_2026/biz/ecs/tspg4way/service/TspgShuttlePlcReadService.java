...
public class TspgShuttlePlcReadService{
    ...
    public void updatePlcStatus(Tspg4WayShuttlePlc carPlc){
        ...
        int row = Character.getNumericValue(String.valueOf(readMap.getShuttleCellLocation()) .charAt(0));
        int bay = Character.getNumericValue(String.valueOf(readMap.getShuttleCellLocation()) .charAt(2));
