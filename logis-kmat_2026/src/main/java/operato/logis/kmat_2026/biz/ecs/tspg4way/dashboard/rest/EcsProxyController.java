...
public class EcsProxyController {
    ...
    public ResponseEntity<Map<String, Object>> cancelJob(
        ...
        logger.info("Proxy: Cancel job request - lcId={}, jobKey={}", lcId, jobKey);
        ...
        try {
            ...
            logger.error("Failed to proxy cancel job to ECS: {}", e.getMessage(), e);
    ...
    public ResponseEntity<Map<String, Object>> resumeJob(
        ...
        logger.info("Proxy: Resume job request - lcId={}, jobKey={}", lcId, jobKey);
        ...
        try {
            ...
            logger.error("Failed to proxy resume job to ECS: {}", e.getMessage(), e);
            return ResponseEntity.status(HttpStatus.BAD_GATEWAY).body(Map.of(
                "accepted", false,
                "message", "Failed to connect to ECS: " + e.getMessage(),
                "jobKey", jobKey
    ...
    public ResponseEntity<Map<String, Object>> updateJobPriority(
        ...
        logger.info("Proxy: Update job priority request - lcId={}, jobKey={}, priority={}",
        ...
        try {
            ...
            logger.error("Failed to proxy update job priority to ECS: {}", e.getMessage(), e);
            return ResponseEntity.status(HttpStatus.BAD_GATEWAY).body(Map.of(
                "accepted", false,
                "message", "Failed to connect to ECS: " + e.getMessage(),
                "jobKey", jobKey
    ...
    public ResponseEntity<Map<String, Object>> stopShuttle(
        ...
        logger.info("Proxy: Stop shuttle request - lcId={}, shuttleCode={}", lcId, shuttleCode);
        ...
        try {
            ...
            logger.error("Failed to proxy stop shuttle to ECS: {}", e.getMessage(), e);
            return ResponseEntity.status(HttpStatus.BAD_GATEWAY).body(Map.of(
                "accepted", false,
                "message", "Failed to connect to ECS: " + e.getMessage(),
                "shuttleCode", shuttleCode
    ...
    public ResponseEntity<Map<String, Object>> restartShuttle(
        ...
        logger.info("Proxy: Restart shuttle request - lcId={}, shuttleCode={}", lcId, shuttleCode);
        ...
        try {
            ...
            logger.error("Failed to proxy restart shuttle to ECS: {}", e.getMessage(), e);
            return ResponseEntity.status(HttpStatus.BAD_GATEWAY).body(Map.of(
                "accepted", false,
                "message", "Failed to connect to ECS: " + e.getMessage(),
                "shuttleCode", shuttleCode
    ...
    public ResponseEntity<Map<String, Object>> moveShuttle(
        ...
        logger.info("Proxy: Move shuttle request - lcId={}, shuttleCode={}, target={}",
        ...
        try {
            ...
            logger.error("Failed to proxy move shuttle to ECS: {}", e.getMessage(), e);
            return ResponseEntity.status(HttpStatus.BAD_GATEWAY).body(Map.of(
                "accepted", false,
                "message", "Failed to connect to ECS: " + e.getMessage(),
                "shuttleCode", shuttleCode
    ...
    public ResponseEntity<Map<String, Object>> acknowledgeAlarm(
        ...
        logger.info("Proxy: Acknowledge alarm request - lcId={}, alarmId={}", lcId, alarmId);
        ...
        try {
            ...
            logger.error("Failed to proxy alarm ack to ECS: {}", e.getMessage(), e);
            return ResponseEntity.status(HttpStatus.BAD_GATEWAY).body(Map.of(
                "accepted", false,
                "message", "Failed to connect to ECS: " + e.getMessage(),
                "alarmId", alarmId
    ...
    public ResponseEntity<Map<String, Object>> resetAlarm(
        ...
        logger.info("Proxy: Reset alarm request - lcId={}, alarmId={}", lcId, alarmId);
        ...
        try {
            ...
            logger.error("Failed to proxy alarm reset to ECS: {}", e.getMessage(), e);
            return ResponseEntity.status(HttpStatus.BAD_GATEWAY).body(Map.of(
                "accepted", false,
                "message", "Failed to connect to ECS: " + e.getMessage(),
                "alarmId", alarmId
