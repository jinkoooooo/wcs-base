...
import operato.logis.kmat_2026.biz.ecs.tspg4way.service.TspgShuttleOrderService;
...
public class TspgShuttleOrderScheduler {
    ...
    public TspgShuttleOrderScheduler(ThreadPoolTaskScheduler taskScheduler, TspgShuttlePlcRegistry tspgShuttlePlcRegistry,
                                     TspgShuttleMapRegistry tspgShuttleMapRegistry, TspgShuttlePlcWriteService tspgShuttlePlcWriteService, String rackEqId, int floor ) {
        this.taskScheduler = taskScheduler;
        tspgShuttleOrderService = new TspgShuttleOrderService(
                tspgShuttlePlcRegistry, tspgShuttleMapRegistry, tspgShuttlePlcWriteService, rackEqId, floor
                );
        this.floor = floor;
    }
