 ...
 * - wcsConsts:      WCS 오더/로케이션/재고 상태 + 라벨 (EnumEntry 통합 패턴)
 * - jobUiStatus:    프론트 추상 작업 상태 (PENDING/ASSIGNED/...)
 * - statusMapper:   WCS/ECS 도메인 status ↔ JobUiStatus 변환
