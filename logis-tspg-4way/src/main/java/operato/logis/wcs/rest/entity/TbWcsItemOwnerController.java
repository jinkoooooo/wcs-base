...
import operato.logis.wcs.entity.TbWcsItemOwner;
...
/**
 * 화주(ItemOwner) 마스터 CRUD REST.
 * Elidom 표준 CRUD(검색/단건/생성/수정/삭제/다건/POST 검색) 진입점.
 */
@RestController
@Transactional
@ResponseStatus(HttpStatus.OK)
@RequestMapping("/rest/tbwcsitemowner")
@ServiceDesc(description = "TbWcsItemOwner Service API")
public class TbWcsItemOwnerController extends AbstractRestService {

    @Override
    protected Class<?> entityClass() {
        return TbWcsItemOwner.class;
    }
    ...
    public TbWcsItemOwner findOne(@PathVariable("id") String id) {
    ...
    public TbWcsItemOwner create(@RequestBody TbWcsItemOwner input) {
        return this.createOne(input);
    }

    @RequestMapping(value = "/{id}", method = RequestMethod.PUT, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiDesc(description = "Update")
    public TbWcsItemOwner update(@PathVariable("id") String id, @RequestBody TbWcsItemOwner input) {
    ...
    public Boolean multipleUpdate(@RequestBody List<TbWcsItemOwner> list) {
