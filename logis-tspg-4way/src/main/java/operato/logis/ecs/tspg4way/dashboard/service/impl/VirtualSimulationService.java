...
public class VirtualSimulationService {
    ...
    public Map<String, Object> generateVirtualEquipment(
        ...
        logger.info("[ Sim ][ Virtual ] generating equipment: lcId={}, eqGroupId={}", lcId, eqGroupId);
        ...
        logger.info("[ Sim ][ Virtual ] generated equipment: racks={}, cars={}, rackCells={}, conveyors={}",
    ...
    private void ensureEqGroupMstExists(String eqGroupId) {
        ...
        logger.info("[ Sim ][ Virtual ] inserted eq group: id={}, name={}, type={}", g.getId(), g.getName(), g.getType());
    }
    ...
    public Map<String, Object> autoMapLayoutsToVirtualEquipment(String lcId, String pageId) {
        logger.info("[ Sim ][ Virtual ] auto-mapping layouts: pageId={}", pageId);
        ...
        logger.info("[ Sim ][ Virtual ] auto-mapped layouts: count={}", mappedCount);
    ...
    public void clearVirtualData(String eqGroupId) {
        ...
        logger.info("[ Sim ][ Virtual ] cleared data: eqGroupId={}", eqGroupId);
    }
    ...
    public synchronized void startSimulation(String lcId, String eqGroupId) {
        if (isSimulating) {
            logger.warn("[ Sim ][ Virtual ] already running");
            return;
        }

        logger.info("[ Sim ][ Virtual ] starting: lcId={}, eqGroupId={}", lcId, eqGroupId);
        ...
        logger.info("[ Sim ][ Virtual ] initialized: shuttles={}, layoutPositions={}",
            virtualShuttles.size(), layoutPositionCache.size());

        if (virtualShuttles.isEmpty()) {
            logger.warn("[ Sim ][ Virtual ] no shuttles found: eqGroupId pattern=%{}%", eqGroupId);
        }
        ...
        scheduler.scheduleAtFixedRate(() -> {
            ...
            try {
                ...
                logger.error("[ Sim ][ Virtual ] shuttle simulation error", e);
            }
        ...
        scheduler.scheduleAtFixedRate(() -> {
            ...
            try {
                ...
                logger.error("[ Sim ][ Virtual ] order simulation error", e);
            }
        }, 2000, 5000, TimeUnit.MILLISECONDS);

        logger.info("[ Sim ][ Virtual ] started");
    }
    ...
    public synchronized void stopSimulation() {
        ...
        logger.info("[ Sim ][ Virtual ] stopped");
    }
    ...
    private void initializeLayoutPositionCache(String lcId, String eqGroupId) {
        ...
        logger.info("[ Sim ][ Virtual ] layout cache initialized: total={}, rackCells={}, conveyors={}, floors={}",
    ...
    private void initializeVirtualShuttles(String eqGroupId) {
        ...
        List<TbEqCarMst> cars = this.getQueryManager().selectListBySql(sql, params, TbEqCarMst.class, 0, 0);

        int idx = 0;

        for (TbEqCarMst car : cars) {
            ...
            if (startCellId == null) {
                logger.warn("[ Sim ][ Virtual ] shuttle skipped (no layout cells): shuttle={}, floor={}",
            ...
            if (lp == null) {
                logger.warn("[ Sim ][ Virtual ] shuttle skipped (no position): shuttle={}, cell={}",
        ...
        logger.info("[ Sim ][ Virtual ] shuttles initialized: count={}", virtualShuttles.size());
    }
    ...
    private void broadcastShuttlePositions(String lcId, String eqGroupId) {
        if (virtualShuttles.isEmpty()) {
            logger.debug("[ Sim ][ Virtual ] broadcast skipped (no shuttles)");
            return;
        }
        ...
        logger.debug("[ Sim ][ Virtual ] broadcast sent: shuttles={}, topics={} and {}",
    ...
    private void simulateOrderCreation(String lcId, String eqGroupId) {
        ...
        TbWcsShuttleOrder dbOrder = new TbWcsShuttleOrder();
        ...
        logger.debug("[ Sim ][ Virtual ] order created: {}", order.orderKey);
    ...
    private void completeOrder(VirtualOrder order, String lcId, String eqGroupId) {
        ...
        messagingTemplate.convertAndSend("/topic/shuttle/wcs/order/" + lcId, getAllActiveOrders(eqGroupId));
        logger.debug("[ Sim ][ Virtual ] order completed: {}", order.orderKey);
    }
    ...
    public void testBroadcast(String lcId) {
        String topic = "/topic/shuttle/positions/" + lcId;
        logger.info("[ Sim ][ Virtual ] test broadcast sending: topic={}", topic);
        ...
        logger.info("[ Sim ][ Virtual ] test broadcast sent");
    }
