...
public class TbEcs2dPageService extends AbstractQueryService {
    ...
    public TbEcs2dPage createPage(TbEcs2dPage page) {
        ...
        logger.info("[ Dashboard ][ Page ] creating: lcId={}, eqGroupId={}, floor={}, name={}, index={}",
    ...
    public TbEcs2dPage updatePageEqGroup(String id, String eqGroupId) {
        ...
        logger.info("[ Dashboard ][ Page ] eq group mapping updated: pageId={}, eqGroupId={}", id, eqGroupId);
    ...
    public TbEcs2dPage clearPageEqGroup(String id) {
        ...
        logger.info("[ Dashboard ][ Page ] eq group mapping cleared: pageId={}", id);
    ...
    public TbEcs2dPage updatePageCanvas(String id, Integer canvasWidth, Integer canvasHeight, String backgroundColor) {
        ...
        logger.info("[ Dashboard ][ Page ] canvas updated: pageId={}, width={}, height={}, bgColor={}",
    ...
    public TbEcs2dPage updatePageGrid(String id, Integer gridSize, Boolean showGrid, Boolean snapToGrid) {
        ...
        logger.debug("[ Dashboard ][ Page ] grid updated: pageId={}, gridSize={}, showGrid={}, snapToGrid={}",
    ...
    public void deletePage(String id) {
        if (id == null || id.isEmpty()) {
            logger.warn("[ Dashboard ][ Page ] delete called with empty id");
            return;
        }

        TbEcs2dPage page = this.getPage(id);
        if (page == null) {
            logger.debug("[ Dashboard ][ Page ] page not found for deletion: pageId={}", id);
            return;
        }
        ...
        logger.info("[ Dashboard ][ Page ] deleting: pageId={}, name={}, lcId={}, eqGroupId={}, floor={}, index={}",
        ...
        logger.debug("[ Dashboard ][ Page ] items deleted: count={}, pageId={}", deletedItems, id);
    ...
    public TbEcs2dPage copyPage(String sourcePageId, String newPageName, Integer newFloorLevel) {
        ...
        logger.info("[ Dashboard ][ Page ] copied: name={}, lcId={}, eqGroupId={}, floor={}, sourcePageId={}",
        ...
        logger.info("[ Dashboard ][ Page ] layouts copied: count={}, sourcePageId={}, newPageId={}", copiedCount, sourcePageId, newPage.getId());
        return newPage;
    }
}
