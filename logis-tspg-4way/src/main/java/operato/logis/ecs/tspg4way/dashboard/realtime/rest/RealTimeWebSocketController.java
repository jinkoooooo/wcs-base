...
/**
 * 실시간 데이터 WebSocket(STOMP) 컨트롤러. 구독/해제/하트비트/상태 메시지 처리.
 */
@Controller
public class RealTimeWebSocketController {
    ...
    public void handleSubscribe(
        ...
        logger.debug("[ Realtime ][ Ws ] subscribe request: eqGroupId={}, lcId={}, pageId={}, sessionId={}",
    ...
    public void handleUnsubscribe(
        ...
        String sessionId = headerAccessor.getSessionId();
        logger.debug("[ Realtime ][ Ws ] unsubscribe request: eqGroupId={}, sessionId={}", eqGroupId, sessionId);
