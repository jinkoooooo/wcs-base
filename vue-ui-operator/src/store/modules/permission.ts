...
import { getDeviceType } from "@/utils/logisticUtil";
    ...
    async buildRoutesAction(): Promise<AppRouteRecordRaw[]> {
      ...
      switch (permissionMode) {
        ...
        case PermissionModeEnum.BACK:
          ...
          //todo: loading
          // createMessage.newMessage("top", "", "info", "loading");
          ...
          try {
            ...
            let deviceType = getDeviceType() ?? "TABLET";
            routeList = (await getMenuList(deviceType)) as AppRouteRecordRaw[];
          } catch (error) {
            console.error(error);
          }
          ...
          // 动态引入组件
          routeList = await asyncImportRoute(routeList);
