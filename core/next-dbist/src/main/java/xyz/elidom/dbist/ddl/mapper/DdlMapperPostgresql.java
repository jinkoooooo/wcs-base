 ...
 * @author shortstop
 */
public class DdlMapperPostgresql extends DdlMapperAbstract implements DdlMapper {
	...
	public String tableTemplate() {
		...
		joiner.add("	#end");
		joiner.add("#end");
		joiner.add("	#if($pkExist) CONSTRAINT ${tableName}_pkey PRIMARY KEY ($primaryKeys) #end");
		joiner.add(")");
