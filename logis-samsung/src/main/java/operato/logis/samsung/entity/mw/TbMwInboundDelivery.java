...
@Getter
@Setter
@Table(name = "tb_mw_inbound_delivery", idStrategy = GenerationRule.UUID)
public class TbMwInboundDelivery extends ElidomStampHook {
    ...
    @Column(name = "manual_flag", nullable = false) // 이거 겟이 안먹히는데 왜그럴까?
